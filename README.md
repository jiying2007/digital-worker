...
候选包括飞书、WorkBuddy、WeKnora、Codex、Claude Code、IDE/Internal Agent；知识/证据 Source 包括飞书文档、NAS、Git、CI/HIL、Artifact Store。候选名称不是总体架构硬依赖。
...
2. 机器资产冲突按 `expert-groups/embedded-system/governance/authority-index.md` 裁决；

...
def main() -> None:
    ...
    expected = {
        ...
        "runtime_practice_eval": ("jiying2007/llm_agent", "1.4"),
    }
    ...
    require("R2_LOCAL_TERMINAL_POLICY" in runtime_eval.get("validation", ""), "llm_agent local-terminal R2 portability policy must be explicitly promoted")
